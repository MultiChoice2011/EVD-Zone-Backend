...
use App\Http\Middleware\RestrictAdminAccessMiddleware;
...
//        'role_or_permission' => \Spatie\Permission\Middlewares\RoleOrPermissionMiddleware::class,
        ...
        'authGurad' => \App\Http\Middleware\AssignGuard::class,
        'maintenanceMode' => \App\Http\Middleware\CheckMaintenanceMode::class,
        ...
        'check_admin_access' => RestrictAdminAccessMiddleware::class,
    ];
}
