...
return [
    ...
    "data_exist_before" => "هذه البيانات قد تكون موجوده مسبقا",
    ...
    "no_data" => "لا يوجد",
    "related_items" => "عذرا لا يمكن مسح هذا العنصر لارتباطه بعدد من العناصر الاخرى",
    "unable_restore" => "لا يمكن استرجاع العنصر. من المحتمل وجود عنصر اخر بهذه القيم الغير مسموح تكرارها",
    "general_validation" =>
        [
    ...
    "clients" => [
        ...
        "validations" => [
            ...
            "unique_name" => 'هذا الاسم مستخدم من قبل',
        ]
    ],
    "about" => [
        "page_title" => "من نحن",
    ...
    "vendorWallets" => [
        ...
        "manage_wallet_balance" => "إدارة رصيد الحساب",
        "current_wallet_balance" => "رصيد الحساب الحالي",
        "subtract" => "خصم",
        ...
        "transaction" => [
            "title" => "إدارة رصيد الحساب",
            "wallet_transactions_log" => "سجل معاملات الحساب",
            "id" => "معرف المعاملة",
            "type" => "نوع المعاملة",
